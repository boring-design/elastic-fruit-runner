Feature: Controller lifecycle with GitHub App auth

  The controller connects to GitHub Actions using a GitHub App,
  ...
  Scenario: end-to-end workflow execution with GitHub App auth
    Given a GitHub scaleset client is configured using GitHub App auth
